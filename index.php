    ...
    <body>
        ...
        ">
              ...
              md:pt-0">
                            ...
                            <li>
                                <a class="md:p-4 py-2 block hover:bg-purple-600" href="/intrapanel/views/add.php">Post new Blog</a>
                            </li>
                            <li>
        ...
        <div class="px-4 my-5 container mx-auto">
            <h2 class="leading-1 text-xl font-bold">All Articles</h2>
                    ...
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        <div class="sm:flex sm:items-center px-6 py-4">
                            <div class="text-center sm:text-left sm:flex-grow">
                                <div class="mb-4">
                                    <p class="text-xl leading-tight capitalize "><?php echo $article['article_title'] ?></p>
                                    <p class="text-sm leading-tight text-gray-600">By <?php echo $article['article_author']; ?></p>
                                </div>
                                <div class="mb-5">
                                    <?php echo $article['article_content']; ?>
                                </div>
                                <div class="flex justify-between">
                                    <!-- <a href="?id=<?php echo $article['article_id']; ?>" class="text-sm font-semibold text-purple-500 hover:text-purple-600">Read more</a> -->
                                    <div class="text-purple-500"><?php echo date('l jS', $article['article_timestamp']) ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
