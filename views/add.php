    ...
    <body>
        ...
        ">
              ...
              md:pt-0">
                            ...
                            <li>
                                <a class="md:p-4 py-2 block bg-purple-400 text-white hover:bg-purple-600" href="/intrapanel/views/add.php">Post new Blog</a>
                            </li>
                            <li>
                                <a class="md:p-4 py-2 block hover:text-white hover:bg-purple-400" href="/intrapanel/views/delete.php">Delete Artical</a>
                            </li>
                            <li>
                                <a class="md:p-4 py-2 block hover:text-white hover:bg-purple-400" href="/intrapanel/views/logout.php">Logout</a>
                            </li>
                        </ul>
                    </div>
                </nav>
        ...
        <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto">
                <div class="flex flex-col text-center w-full mb-12">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Add new Article</h1>
                </div>
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                    <form action="add.php" method="post">
                        <?php if (isset($error)) { ?>
                            <div class="text-red-600 p-3 bg-red-200 w-full rounded-md mb-2"><?php echo $error; ?></div>
                            <br /><br />
                        <?php } ?>
                        <div class="flex flex-wrap -m-2">
                            <div class="p-2 w-1/2">
                                <div class="relative">
                                    ...
                                    <input type="text" name="title" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                            </div>
                            <div class="p-2 w-1/2">
                                <div class="relative">
                                    <label for="author" class="leading-7 text-sm text-gray-600">Author</label>
                                    <input type="text" name="author" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                </div>
                            </div>
                            <div class="p-2 w-full">
                                <div class="relative">
                                    <label for="content" class="leading-7 text-sm text-gray-600">Content</label>
                                    <textarea name="content" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                </div>
                            </div>
                            <div class="p-2 w-full">
                                <button type="submit" class="flex mx-auto text-white bg-[#c084fc] border-0 py-2 px-8 focus:outline-none hover:bg-[#c084fc] rounded text-lg">Button</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php
    ...
    header('Location: /intrapanel/views/login.php');
}
