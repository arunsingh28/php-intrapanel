    ...
    <body>
        ...
        ">
              ...
              md:pt-0">
                            ...
                            <li>
                                <a class="md:p-4 py-2 block hover:bg-purple-400 hover:text-white hover:bg-purple-600" href="/intrapanel/views/add.php">Post new Blog</a>
                            </li>
                            <li>
                                <a class="md:p-4 py-2 block text-white bg-purple-400 hover:bg-purple-500" href="/intrapanel/views/delete.php">Delete Artical</a>
                            </li>
                            <li>
