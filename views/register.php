                 ...
                 <div class="mt-12">
                     <form action="../includes/register.php" method="post">
                         ...
                         <div>
                             ...
                             <input required class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" name="name" placeholder="Enter your full name">
                         </div>
                         <div>
                             <div class="text-sm font-bold text-gray-700 tracking-wide mt-5">Email Address</div>
                             <input required class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" name="email" placeholder="arun@gmail.com">
                         </div>
                         <div class="mt-8">
                             ...
                             <input required class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="password" name="password" placeholder="Enter your password">
                         </div>
                         <div class="mt-10">
                     ...
                     <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                         Already have an account ? <a href="/intrapanel/views/login.php" class="cursor-pointer text-indigo-600 hover:text-indigo-800">Login
                         </a>
                     </div>
                 </div>
             </div>
