                ...
                <div class="mt-12">
                    <form action="/intrapanel/php/register.php" method="post">
                        <div>
                            ...
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" name="name" placeholder="Enter your full name">
                        </div>
                        <div>
                            <div class="text-sm font-bold text-gray-700 tracking-wide mt-5">Email Address</div>
                            <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" name="email" placeholder="arun@gmail.com">
                        </div>
                        <div class="mt-8">
